...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> myWords = this.getTokens("[a-zA-Z]+");
...
//			return 0;
//		}
//		String[] mySentences = getText().split("[.!?]+", 0);
//		int count = mySentences.length;
//		
//        return mySentences.length;
	...
	public int getNumSyllables()
	{
		...
		int sum = 0;
		List<String> myWords = this.getTokens("[a-zA-Z]+");
		for (String curWord : myWords)
		{
			sum += countSyllables(curWord);
		}
