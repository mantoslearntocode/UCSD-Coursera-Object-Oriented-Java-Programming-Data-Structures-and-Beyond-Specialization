...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String toTest = getStringFromFile(textfile, numToCheck);
			...
			BasicDocument newTest = new BasicDocument(toTest);
			newTest.getFleschScore();
			...
			EfficientDocument newETest = new EfficientDocument(toTest);
			newETest.getFleschScore();
